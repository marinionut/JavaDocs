...
public class Student {
    ...
    public String toString() {
        String myStudent = "";
        myStudent = id.toString() + " " + firstName + " " + lastName + " " + averageGrade;
    ...
    public boolean equals(Object o) {
        ...
        if(this.id == myStud.id && this.firstName == myStud.firstName && this.lastName == myStud.lastName && this.averageGrade == myStud.averageGrade)
            return true;
